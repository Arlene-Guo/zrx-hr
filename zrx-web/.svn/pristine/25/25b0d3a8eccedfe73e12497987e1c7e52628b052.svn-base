		...
		if ($('#clockIframe_2').length > 0) {
			...
			if (showTime == "default" || showTime == "minutes") {
				...
				for (var i = 0; i <= 60; i += 5) {
					var li = $('<li class="ominsLi" style="display:inline-block;width:18px;padding:2px;border:1px solid #fff;border-radius:3px;text-align:center;cursor:pointer;"><a href="javascript:void(0);" style="text-decoration:none;">' + (i==60 ? 59 : i) + '</a></li>');
