...
;(function ($) {
    ...
    $.fn.TNScheduleEditor = function (options) {
        ...
        if(opts.view){
            $editorWrapper.find(".btn_save_all").hide();
            setTimeout(function () {
                $editorWrapper.find(".btn_preview_sch").trigger("click");
                $editorWrapper.find(".btn_preview_sch,.btn_preview_close,.btn_add_day").hide(); 
            },1);
        }      
    };
