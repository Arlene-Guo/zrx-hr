					...
					},
					{
						...
						handler:function(v,data,n){
							if(data.state==3||data.state==7){
								...
								n.html('未通过');
							}else if(data.state==4||data.state==8){
								n.html('待反馈');
						...
						handler: function(v, data, n) {
							...
							} else if(data.state == 5||data.state == 6||data.state == 9||data.state == 10){
							...
							}else if(data.state==3||data.state==7||data.state==11){
