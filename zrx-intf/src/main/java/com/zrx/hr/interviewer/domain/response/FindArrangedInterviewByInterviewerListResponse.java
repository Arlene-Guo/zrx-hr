package com.zrx.hr.interviewer.domain.response;
...
public class FindArrangedInterviewByInterviewerListResponse extends CommonResponseVO<CommonResult<FindArrangedInterviewListDtoIntegration>>{
