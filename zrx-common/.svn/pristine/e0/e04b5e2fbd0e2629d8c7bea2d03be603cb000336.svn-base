...
public class ShortHttpsUtil {

    protected ShortHttpsUtil() {
    }

    private static HttpClient client = HttpClient4.getDefaultHttpClient(10000, null, null);
    ...
    public static String getContent(HttpClient httpClient, String method, String url, final String data, boolean base64, Header... headers)
        ...
        if (StringUtils.isNotBlank(data) && base64) {
            requestData = Base64.encodeBase64String(data.getBytes());
        }
